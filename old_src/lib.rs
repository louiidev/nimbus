...
pub const DEFAULT_TEXTURE_ID: ArenaId = ArenaId::from_u128(0xa1a2a3a4b1b2c1c2d1d2d3d4d5d6d7d8u128);

pub const DEFAULT_FONT_ID: ArenaId = ArenaId::from_u128(0xa1a2a3a4b1b2c1c2d1d2d3d4d5d6d7d9u128);

const TOGGLE_TRIANGLE_TEXTURE_ID: ArenaId =
    ArenaId::from_u128(0xa1a2a3a4b1b2c1c2d1d2d3d4d5d6d7d1u128);
...
impl App {
    ...
    pub fn insert_asset<T: Send + Sync + 'static>(&mut self, id: ArenaId, resource: T) {
    ...
    pub fn new(window_descriptor: WindowDescriptor) -> Self {
        ...
        let default_font_id = ArenaId::new_v4();
